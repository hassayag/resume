  ...
  <form className={styles.contactForm} action="https://api.web3forms.com/submit" method="POST">
    ...
    <div className={styles.formGroupContainer}>
      <div className={styles.formGroup}>
        ...
        <input id="name" name="name" className={styles.formInput} placeholder="Your name" type="text" required />
      </div>
      <div className={styles.formGroup}>
        <label htmlFor="email" className={styles.formLabel}>Email</label>
        <input id="email" name="email" className={styles.formInput} placeholder="Your email" type="email" required />
      </div>
      <div className={styles.formGroup}>
        <label htmlFor="phone" className={styles.formLabel}>Phone</label>
        <input id="phone" name="phone" className={styles.formInput} placeholder="Your phone number" type="text" />
      </div>
      <div className={styles.formGroup}>
        <label htmlFor="message" className={styles.formLabel}>Message</label>
        <textarea className={styles.formTextarea} id="message" name="message" placeholder="Insert thrilling opportunity, question, or hot take" required></textarea>
      </div>
    </div>
